...
import { 
    ...
    Filter, ChevronRight, User, Mail, Briefcase, MapPin
} from 'lucide-react';
import AppShell from '@/components/layout/AppShell';
import { fetchScheduleArchive } from '@/lib/candidateService';
...
export default function SchedulingArchive() {
    ...
    const downloadCSV = () => {
        ...
        a.setAttribute('download', `breach_interviews_${new Date().toISOString().split('T')[0]}.csv`);
